              ...
              >
                <Card className="bg-white/90 border-orange-200 overflow-hidden shadow-2xl h-full flex flex-col">
                  <div className="relative h-64 md:h-80">
                    <Image unoptimized={true} quality={60} src={event.image} alt={event.name} fill sizes="(max-width: 768px) 100vw, 768px" className="object-cover" loading="lazy" />
                  ...
                  <CardContent className="p-8 flex-grow flex flex-col justify-between">
                    ...
                    <Link prefetch={true} href={event.name === "Dev Deepawali" ? "/packages/dev-deepawali" : "/#packages"}>
