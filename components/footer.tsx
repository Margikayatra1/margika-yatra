      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link href="/">
              <div className="inline-flex items-center space-x-2 mb-4 transition-transform duration-200 hover:scale-105">
                <Image
                  src="/logo.png"
            ...
            <div className="flex space-x-5">
                ...
                className="text-orange-600 hover:text-orange-700 transition-transform duration-200 hover:scale-110"
              >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-gray-700 font-medium text-sm hover:text-orange-600 hover:pl-1 transition-all duration-200"
                  >
                    {link.label}
                  </Link>
                </li>
