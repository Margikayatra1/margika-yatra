    ...
    <>
      ...
      <section id="choosing-agency" className="scroll-mt-28 border-t border-orange-100/60 pt-6">
        ...
        <ul className="list-disc pl-5 mb-6 space-y-2">
          ...
          <li>Can they arrange a <Link href="/personalized-trip" className="text-orange-600 hover:underline"><strong>customized pilgrimage tour India</strong></Link> based on your pace and preferences?</li>
...
export default function BlogDetailPage() {
  ...
  const blog = blogDatabase[slug] || blogDatabase["first-time-pilgrim-guide"]
